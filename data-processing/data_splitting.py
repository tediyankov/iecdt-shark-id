...
EXTERNAL_CSV = "/gws/nopw/j04/iecdt/tyankov/iecdt-shark-id/roboflow_train_labels.csv" # this was my path, but you can use wherever you have your data saved (from which you're gap filling)
...
FINETUNE_SAMPLES = {
    'grey_reef_shark': {'my_data': 200, 'external': 0},  
...
# combining all fine-tuning samples
...
# creating detailed split summary
summary = []
for cls in TARGET_CLASSES:
...
if copy_images in ['yes', 'y']:
    ...
    for idx, row in test_df.iterrows():
        ...
        # creating destination directory (organized by class)
